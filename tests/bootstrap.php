...
function _manually_load_plugin() {
	if ( ! defined( 'WOO_DYNAMIC_GALLERY_TRAVIS' ) ) { 
		define( 'WOO_DYNAMIC_GALLERY_TRAVIS', true );
	}
	...
	echo esc_html( 'Loading WC Dynamic Gallery plugin' . PHP_EOL );
	require dirname( dirname( __FILE__ ) ) . '/wc_dynamic_gallery_woocommerce.php';
