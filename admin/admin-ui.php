...
class Admin_UI
{
	...
	public $plugin_prefix = WOO_DYNAMIC_GALLERY_PREFIX;

	/**
	 * @var string
	 * You must change to correct pro plugin page url on a3rev site
	 */
	public $pro_plugin_page_url = 'https://a3rev.com/shop/woocommerce-dynamic-gallery/';
	...
	public function __construct() {
		$this->google_api_key_option     = WOO_DYNAMIC_GALLERY_KEY . '_google_api_key';
		$this->google_map_api_key_option = WOO_DYNAMIC_GALLERY_KEY . '_google_map_api_key';
		$this->toggle_box_open_option    = WOO_DYNAMIC_GALLERY_KEY . '_toggle_box_open';
		$this->version_transient         = WOO_DYNAMIC_GALLERY_KEY . '_licinfo';

		if ( defined( 'WOO_DYNAMIC_GALLERY_G_FONTS' ) ) {
			$this->is_load_google_fonts = (boolean) WOO_DYNAMIC_GALLERY_G_FONTS;
		}

		$this->support_url = 'https://wordpress.org/support/plugin/woocommerce-dynamic-gallery/';
